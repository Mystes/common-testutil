 ...
 */
package fi.mystes.synapse.testutil.samples;

import fi.mystes.synapse.testutil.xpath.NamespaceDefinition;
import fi.mystes.synapse.testutil.xpath.XPathUtil;
import fi.mystes.synapse.testutil.xslt.XsltTestHelper;
...
public class HowToUseXsltTestHelperTest {
    ...
    public void howToTestSimpleXsltTransformation() throws TransformerException, XPathExpressionException {
        ...
        InputStream sourceXml = stringAsInputStream(sampleXmlString());
        ...
        InputStream xsltStream = classpathResource("SampleXsltNoNamespaces.xsl");
    ...
    public void howToTestXsltWithNamespace() throws TransformerException, XPathExpressionException {
        ...
        InputStream xsltStream = classpathResource("SampleXsltWithNamespaces.xsl");
        String result = XsltTestHelper.transform(sourceXml, xsltStream);
